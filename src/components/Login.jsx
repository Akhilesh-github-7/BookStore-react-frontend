      ...
      <div className="bg-white bg-opacity-20 backdrop-filter backdrop-blur-lg border border-gray-300 border-opacity-30 rounded-xl shadow-lg p-8 max-w-md w-full text-white dark:bg-gray-800 dark:bg-opacity-20 dark:border-gray-700">
        ...
        <form onSubmit={handleSubmit}>
          ...
          <div className="flex justify-between text-sm mb-6">
            <Link to="/forgot-password" className="text-white dark:text-gray-300 hover:text-gray-200 dark:hover:text-white">{t('Forgot Password ?')}</Link>
            <Link to="/register" className="text-white dark:text-gray-300 hover:text-gray-200 dark:hover:text-white">{t('Sign Up')}</Link>
          </div>

          <div className="relative flex py-5 items-center">
            <div className="flex-grow border-t border-gray-400 dark:border-gray-600"></div>
            <span className="flex-shrink mx-4 text-gray-400 dark:text-gray-500">{t('OR LOGIN WITH')}</span>
            <div className="flex-grow border-t border-gray-400 dark:border-gray-600"></div>
          </div>
